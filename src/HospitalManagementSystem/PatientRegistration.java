 ...
 * @author nabee
 */
public class PatientRegistration extends javax.swing.JFrame implements Serializable {

    Everyone patient1 = null;
  private int Id= 0;
    public PatientRegistration() {
        initComponents();
         File Pat = new File("PatientRec.txt");
    ...
    private void Reset()
{
   ...
   Statement stmt;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        this.hide();
        PatientRecord frm=new PatientRecord();
        frm.setVisible(true);   
